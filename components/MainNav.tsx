// TODO: this server component is currently limited because it prevents the use of components that require client side actions like useEffect of useState. Ideally, we would get this data on the server in `layout.tsx` then pass it into Header.tsx as a prop. This would allow all MainNav actions to happen client side.
...
// TODO:
// This is a server component by default. When importing NextUI via the @nextui-org/react package
// a useEffect on server error was thrown.
// Importing these NavBar components from the individual `navbar` package prevents this error.
// Eventually we will remove the full @nextui-org/react package in favor
// or only the individual components used
